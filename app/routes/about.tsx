...
type Member = (typeof team.mentors)[number];

export function meta() {
  return [
    { title: "Enigma | About" },
    { name: "description", content: "Meet the Enigma AI/ML club team" },
  ];
}
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 w-full p-6 transform transition-transform duration-300">
        ...
        <p className="text-sm font-medium text-cyan-400 uppercase tracking-wider">{member.role}</p>
      </div>
    </motion.div>
  );
};
            ...
            >
              ...
              <div className="p-8 pt-0 relative -mt-12">
                <div className="bg-slate-900/90 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-xl">
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed mb-6">{selectedMember.description}</p>

                  <div className="flex items-center gap-4">
                    <a
                      href={selectedMember.github}
                      className="p-3 rounded-full bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white transition-colors border border-white/5"
                    >
