...
export const testimonials = [
  { id: 1, name: "Alice Johnson", role: "Alumni", text: "Enigma gave me the practical exposure I needed to kickstart my AI career." },
  { id: 2, name: "Bob Smith", role: "Student", text: "The community here is incredibly supportive and forward-thinking." },
  { id: 3, name: "Charlie Davis", role: "Industry Expert", text: "A brilliant group of minds shaping the future of technology." }
];
...
export const events = [
  ...
  },
  {
    ...
    date: "2026-03-10",
    type: "chai talks" as EventType,
    status: "current" as EventStatus,
